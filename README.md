...
| **Going Merry** | OpenVZ VPS | Light/legacy Docker node |
...
**No HA, no Kubernetes** — reproducibility + backups + unified management, by design.

## Layout
Top-level dirs are per-ship (map onto Komodo server targets). Cross-cutting
concerns live at root: `komodo/`, `scripts/`, `docs/`, `.sops.yaml`.

See [`docs/superpowers/specs/2026-07-18-infra-foundation-design.md`](docs/superpowers/specs/2026-07-18-infra-foundation-design.md)
for the full foundation design.
