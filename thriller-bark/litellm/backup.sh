...
# LiteLLM's only — Open-WebUI has its own database in its own stack, with its own
# backup.sh (docs/ADR/2026-07-28-one-database-per-app.md). Run by the node's backup timer
