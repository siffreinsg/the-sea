...
**This same fact breaks `docs/plans/2026-07-25-llm-stack.md`**, which has Open-WebUI
dialing LiteLLM at `http://127.0.0.1:4000/v1` from a bridged container. That plan needs
the same network — noted there too. It does not affect Karakeep, which reaches LiteLLM
over the mesh from another node.
